...
export function StepModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
      <div className="bg-neutral-900 rounded-xl w-[90vw] max-w-[800px] max-h-[90vh] overflow-hidden shadow-xl">
        {/* Modal Header */}
        <div className="p-4 border-b border-neutral-700/50 flex items-center justify-between">
          <h2 className="text-lg font-semibold text-white">Edit Step Configuration</h2>
